...
export class DataService {
  ...
  getMovieByCategory(selectedCategory: string, page: number) {
    const apiUrl = `${environment.PUBLIC_ENDPOINT}/movie/${selectedCategory}?api_key=${environment.PUBLIC_API_KEY}&include_adult=false&include_video=false&language=en-US&page=${page}`;
